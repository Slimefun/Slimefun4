...
public final class TestUtilities {
    ...
    Inventory mockInventory(InventoryType type, ItemStack... contents) {
    ...
    @ParametersAreNonnullByDefault
    public static @Nonnull
    ItemGroup getItemGroup(Plugin plugin, String name) {
        return new ItemGroup(new NamespacedKey(plugin, name), new CustomItemStack(Material.NETHER_STAR, "&4Test ItemGroup"));
    }

    @ParametersAreNonnullByDefault
    public static @Nonnull
    SlimefunItem mockSlimefunItem(Plugin plugin, String id, ItemStack item) {
    ...
    @ParametersAreNonnullByDefault
    public static @Nonnull
    VanillaItem mockVanillaItem(Plugin plugin, Material type, boolean enabled) {
        ItemGroup itemGroup = new ItemGroup(new NamespacedKey(plugin, "test"), new CustomItemStack(Material.EMERALD, "&4Test ItemGroup"));
    ...
    @ParametersAreNonnullByDefault
    public static @Nonnull
    PlayerProfile awaitProfile(OfflinePlayer player) throws InterruptedException {
