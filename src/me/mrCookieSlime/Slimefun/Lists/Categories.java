...
public class Categories {
	...
	public static Category ARMOR = new Category(new MenuItem(Material.IRON_CHESTPLATE, "&7防具", 0, "open"), 2);
	public static Category LUMPS_AND_MAGIC = new Category(new MenuItem(Material.FIRE_CHARGE, "&7魔法物品", 0, "open"), 2);
	public static Category MAGIC = new Category(new MenuItem(Material.BLAZE_POWDER, "&7魔法工具", 0, "open"), 3);
	...
	public static Category TECH_MISC = new Category(new MenuItem(Material.COMPARATOR, "&7科技零件", 0, "open"), 2);
	public static Category MAGIC_ARMOR = new Category(new MenuItem(Material.GOLDEN_CHESTPLATE, "&7魔法防具", 0, "open"), 2);
	public static Category TALISMANS_1 = new Category(new MenuItem(Material.EMERALD, "&7护身符 - &a1级", 0, "open"), 2);
	public static LockedCategory TALISMANS_2 = new LockedCategory(new MenuItem(Material.EMERALD, "&7护身符 - &a2级", 0, "open"), 3, TALISMANS_1);
