...
public final class Categories {
	...
	public static final Category LUMPS_AND_MAGIC = new Category(new CustomItem(Material.FIRE_CHARGE, "&7Magical Items", "", "&a> Click to open"), 2);
	public static final Category MAGIC = new Category(new CustomItem(Material.BLAZE_POWDER, "&7Magical Gadgets", "", "&a> Click to open"), 3);
	...
	public static final Category TECH_MISC = new Category(new CustomItem(Material.COMPARATOR, "&7Technical Components", "", "&a> Click to open"), 2);
	public static final Category MAGIC_ARMOR = new Category(new CustomItem(Material.GOLDEN_CHESTPLATE, "&7Magical Armor", "", "&a> Click to open"), 2);
