...
public class RecipeType {
	...
	public static final RecipeType MOB_DROP = new RecipeType(new CustomItem(Material.LEGACY_MONSTER_EGG, "&bMob Drop", 0, new String[] {"", "&a&oKill the specified Mob to obtain this Item"}));
	...
	public static final RecipeType COMPRESSOR = new RecipeType(new CustomItem(Material.PISTON_HEAD, "&bCompressor", 0, new String[] {"", "&a&oCompress it using the Compressor"}), "COMPRESSOR");
	...
	@SuppressWarnings("deprecation")
	public static final RecipeType HEATED_PRESSURE_CHAMBER = new RecipeType(new CustomItem(Material.LEGACY_STAINED_GLASS, "&cHeated Pressure Chamber", 8, new String[] {"", "&a&oCraft this Item in a", "&a&oHeated Pressure Chamber"}), "HEATED_PRESSURE_CHAMBER");
