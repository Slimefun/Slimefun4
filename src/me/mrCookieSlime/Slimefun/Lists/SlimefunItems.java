...
public class SlimefunItems {
	...
	public static ItemStack HARDENED_GLASS = new CustomItem(new ItemStack(Material.LIGHT_GRAY_STAINED_GLASS_PANE), "&7Hardened Glass", "", "&rWithstands Explosions");
	...
	public static ItemStack WITHER_PROOF_GLASS = new CustomItem(new ItemStack(Material.BLACK_STAINED_GLASS_PANE), "&5Wither-Proof Glass", "", "&rWithstands Explosions", "&rWithstands Wither Bosses");
	...
	public static ItemStack RAINBOW_WOOL = new CustomItem(new MaterialData(Material.LEGACY_WOOL), "&5Rainbow Wool", "", "&dCycles through all Colors of the Rainbow!");
	public static ItemStack RAINBOW_GLASS = new CustomItem(new MaterialData(Material.LEGACY_STAINED_GLASS), "&5Rainbow Glass", "", "&dCycles through all Colors of the Rainbow!");
	public static ItemStack RAINBOW_CLAY = new CustomItem(new MaterialData(Material.LEGACY_STAINED_CLAY), "&5Rainbow Clay", "", "&dCycles through all Colors of the Rainbow!");
	public static ItemStack RAINBOW_GLASS_PANE = new CustomItem(new MaterialData(Material.LEGACY_STAINED_GLASS_PANE), "&5Rainbow Glass Pane", "", "&dCycles through all Colors of the Rainbow!");
	
	public static ItemStack RAINBOW_WOOL_XMAS = new CustomItem(new MaterialData(Material.LEGACY_WOOL), "&5Rainbow Wool &7(Christmas)", "", Christmas.color("< Christmas Edition >"));
	public static ItemStack RAINBOW_GLASS_XMAS = new CustomItem(new MaterialData(Material.LEGACY_STAINED_GLASS), "&5Rainbow Glass &7(Christmas)", "", Christmas.color("< Christmas Edition >"));
	public static ItemStack RAINBOW_CLAY_XMAS = new CustomItem(new MaterialData(Material.LEGACY_STAINED_CLAY), "&5Rainbow Clay &7(Christmas)", "", Christmas.color("< Christmas Edition >"));
	public static ItemStack RAINBOW_GLASS_PANE_XMAS = new CustomItem(new MaterialData(Material.LEGACY_STAINED_GLASS_PANE), "&5Rainbow Glass Pane &7(Christmas)", "", Christmas.color("< Christmas Edition >"));
	
	public static ItemStack RAINBOW_WOOL_VALENTINE = new CustomItem(new MaterialData(Material.LEGACY_WOOL), "&5Rainbow Wool &7(Valentine's Day)", "", "&d< Valentine's Day Edition >");
	public static ItemStack RAINBOW_GLASS_VALENTINE = new CustomItem(new MaterialData(Material.LEGACY_STAINED_GLASS), "&5Rainbow Glass &7(Valentine's Day)", "", "&d< Valentine's Day Edition >");
	public static ItemStack RAINBOW_CLAY_VALENTINE = new CustomItem(new MaterialData(Material.LEGACY_STAINED_CLAY), "&5Rainbow Clay &7(Valentine's Day)", "", "&d< Valentine's Day Edition >");
	public static ItemStack RAINBOW_GLASS_PANE_VALENTINE = new CustomItem(new MaterialData(Material.LEGACY_STAINED_GLASS_PANE), "&5Rainbow Glass Pane &7(Valentine's Day)", "", "&d< Valentine's Day Edition >");
	...
	public static ItemStack COMPRESSOR = new CustomItem(Material.PISTON_HEAD, "&bCompressor", 0, new String[] {"", "&a&oCompresses Items"});
	...
	public static ItemStack CRUCIBLE = new CustomItem(Material.CRAFTING_TABLE, "&cCrucible", 0, new String[] {"", "&a&oUsed to smelt Items into Liquids"});
	...
	public static ItemStack REFINERY = new CustomItem(new ItemStack(Material.PISTON_HEAD), "&cRefinery", "", "&rRefines Oil to create Fuel");
	public static ItemStack COMBUSTION_REACTOR = null;
	public static ItemStack ANDROID_MEMORY_CORE = null;
	
	public static ItemStack GPS_TELEPORTER_PYLON = new CustomItem(new ItemStack(Material.PURPLE_TERRACOTTA), "&5GPS Teleporter Pylon", "", "&7Teleporter Component");
	...
	public static ItemStack DEBUG_FISH = new CustomItem(new MaterialData(Material.COD), "&3How much is the Fish?", "", "&eRight Click &rany Block to view it's BlockData", "&eLeft Click &rto break a Block", "&eShift + Left Click &rany Block to erase it's BlockData", "&eShift + Right Click &rto place a Placeholder Block");
