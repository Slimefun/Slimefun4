...
public abstract class FoodFabricator extends AContainer {
	...
	public void registerDefaultRecipes() {
		...
		registerRecipe(12, new ItemStack[] {SlimefunItems.CAN, new ItemStack(Material.POTATO)}, new ItemStack[] {SlimefunItems.ORGANIC_FOOD4});
		registerRecipe(12, new ItemStack[] {SlimefunItems.CAN, new ItemStack(Material.WHEAT_SEEDS)}, new ItemStack[] {SlimefunItems.ORGANIC_FOOD5});
