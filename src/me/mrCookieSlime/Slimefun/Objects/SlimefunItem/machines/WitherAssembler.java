...
public class WitherAssembler extends SlimefunItem {
		...
		new BlockMenuPreset(name, getInventoryTitle()) {
			...
			public void newInstance(final BlockMenu menu, final Block b) {
				try {
					...
					menu.replaceExistingItem(31, new CustomItem(new MaterialData(Material.PISTON_HEAD), "&7Offset: &3" + offset + " Block(s)", "", "&rLeft Click: &7+0.1", "&rRight Click: &7-0.1"));
	...
	private void constructMenu(BlockMenuPreset preset) {
		...
		preset.addItem(1, new CustomItem(new ItemStack(Material.WITHER_SKELETON_SKULL), "&7Wither Skull Slot", "", "&rThis Slot accepts Wither Skeleton Skulls"),
		new MenuClickHandler() {
