...
public class AdvancedCargoInputNode extends SlimefunItem {
    ...
    public AdvancedCargoInputNode(Category category, ItemStack item, String name, RecipeType recipeType, ItemStack[] recipe, ItemStack recipeOutput) {
        super(category, item, name, recipeType, recipe, recipeOutput);

        new BlockMenuPreset(name, "&1Input Node") {
            ...
            public void newInstance(BlockMenu menu, Block b) {
                try {
                        ...
                        if (Boolean.valueOf(BlockStorage.getBlockInfo(b, "furnace"))) {
                            ...
                            menu.addMenuClickHandler(7, new MenuClickHandler() {
                                ...
                                public boolean onClick(Player player, int i, ItemStack itemStack, ClickAction clickAction) {
                                    ...
                                    chooseSlotMenu.addItem(10, new CustomItem(new MaterialData(Material.FURNACE), "All", "",
                                            "The result, fuel, and smelting are input in cargo network"));
                                    chooseSlotMenu.addMenuClickHandler(10, new MenuClickHandler() {
                                        @Override
                                        public boolean onClick(Player player, int i, ItemStack itemStack, ClickAction clickAction) {
                                            BlockStorage.addBlockInfo(b, "furnace-slot", "All");
                                            menu.replaceExistingItem(7, new CustomItem(new MaterialData(Material.FURNACE), "Choose slot", "",
                                                    "Currently: All"));
                                            menu.open(player);
                                            return false;
                                        }
                                    ...
                                    chooseSlotMenu.addItem(11, new CustomItem(new MaterialData(Material.FURNACE), "Fuel/Smelting", "", "The fuel and smelting are input in cargo network"));
                                    ...
                                    chooseSlotMenu.addItem(12, new CustomItem(new MaterialData(Material.FURNACE), "Result/Fuel", "", "The result and fuel are input in cargo network"));
                                    ...
                                    chooseSlotMenu.addItem(13, new CustomItem(new MaterialData(Material.FURNACE), "Result/Smelting", "", "The result and smelting are input in cargo network"));
                                    ...
                                    chooseSlotMenu.addItem(14, new CustomItem(new MaterialData(Material.FURNACE), "Smelting", "", "The smelting are input in cargo network"));
                                    ...
                                    chooseSlotMenu.addItem(15, new CustomItem(new MaterialData(Material.FURNACE), "Fuel", "", "The fuel are input in cargo network"));
                                    ...
                                    chooseSlotMenu.addItem(16, new CustomItem(new MaterialData(Material.FURNACE), "Result", "", "The result are input in cargo network"));
                    ...
                    if (!BlockStorage.hasBlockInfo(b) || BlockStorage.getBlockInfo(b, "filter-type") == null || BlockStorage.getBlockInfo(b, "filter-type").equals("whitelist")) {
                        menu.replaceExistingItem(15, new CustomItem(new MaterialData(Material.WOOL), "&7Type: &rWhitelist", "", "&e> Click to chnage it to Blacklist"));
                        ...
                        menu.replaceExistingItem(15, new CustomItem(new MaterialData(Material.WOOL, (byte) 15), "&7Type: &bBlacklist", "", "&e> Click to chnage it to Whitelist"));
                        menu.addMenuClickHandler(15, new MenuClickHandler() {
                            @Override
                            public boolean onClick(Player player, int i, ItemStack itemStack, ClickAction clickAction) {
                    ...
                    if (channel == 16) {
                        menu.replaceExistingItem(42, new CustomItem(SlimefunItems.CHEST_TERMINAL, "&bChannel ID: &3"
                                + (channel + 1)));
                        ...
                        menu.replaceExistingItem(42, new CustomItem(new MaterialData(Material.WOOL, (byte) channel), "&bChannel ID: &3"
                                + (channel + 1)));
                        menu.addMenuClickHandler(42, new MenuClickHandler() {
                    ...
                    menu.addMenuClickHandler(43, new MenuClickHandler() {
                        ...
                        @Override
                        public boolean onClick(Player p, int arg1, ItemStack arg2, ClickAction arg3) {
                            int channel = Integer.parseInt(BlockStorage.getBlockInfo(b, "frequency"));
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        ...
        preset.addItem(2, new CustomItem(new MaterialData(Material.PAPER), "&cItems", "", "&bPut in all Items you want to", "&bblacklist/whitelist"),
                new MenuClickHandler() {
                    @Override
                    public boolean onClick(Player player, int i, ItemStack itemStack, ClickAction clickAction) {
                        return false;
