...
public final class ItemStackWrapper extends ItemStack {
    ...
    ItemStackWrapper forceWrap(@Nonnull ItemStack itemStack) {
     ...
     */
    public static @Nonnull
    ItemStackWrapper wrap(@Nonnull ItemStack itemStack) {
        Validate.notNull(itemStack, "The ItemStack cannot be null!");
     ...
     */
    public static @Nonnull
    ItemStackWrapper[] wrapArray(@Nonnull ItemStack[] items) {
     ...
     */
    public static @Nonnull
    List<ItemStackWrapper> wrapList(@Nonnull List<ItemStack> items) {
