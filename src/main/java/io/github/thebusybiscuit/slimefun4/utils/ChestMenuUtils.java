...
public final class ChestMenuUtils {
    ...
    public static @Nonnull
    ItemStack getNotResearchedItem() {
        return NOT_RESEARCHED;
    }

    public static @Nonnull
    ItemStack getInputSlotTexture() {
        return INPUT_SLOT;
    }

    public static @Nonnull
    ItemStack getOutputSlotTexture() {
        return OUTPUT_SLOT;
    }

    public static @Nonnull
    MenuClickHandler getEmptyClickHandler() {
        return CLICK_HANDLER;
    }

    public static @Nonnull
    ItemStack getBackButton(@Nonnull Player p, String... lore) {
        return new CustomItemStack(BACK_BUTTON, "&7\u21E6 " + Slimefun.getLocalization().getMessage(p, "guide.back.title"), lore);
    }

    public static @Nonnull
    ItemStack getMenuButton(@Nonnull Player p) {
    ...
    public static @Nonnull
    ItemStack getSearchButton(@Nonnull Player p) {
    ...
    public static @Nonnull
    ItemStack getWikiButton() {
        return WIKI_BUTTON;
    }

    public static @Nonnull
    ItemStack getPreviousButton(@Nonnull Player p, int page, int pages) {
        if (pages == 1 || page == 1) {
    ...
    public static @Nonnull
    ItemStack getNextButton(@Nonnull Player p, int page, int pages) {
    ...
    public static @Nonnull
    String getProgressBar(int time, int total) {
