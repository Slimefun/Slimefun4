...
public class PlayerProfile {
    ...
    public @Nonnull
    PlayerBackpack createBackpack(int size) {
    ...
    public @Nonnull
    Optional<PlayerBackpack> getBackpack(int id) {
        if (id < 0) {
