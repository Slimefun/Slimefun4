...
public interface AccessManager {
     ...
     * understanding whether a player is on the access list when {@link #getLevel(Player)}
    ...
    /**
     * Purge all currently held data and read from the {@link SlimefunItemStack}
     *
     * @param itemStack The instance of the {@link SlimefunItemStack}
     */
