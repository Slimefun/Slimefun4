...
public class SlimefunItem implements Placeable {
    ...
    SlimefunItem getById(@Nonnull String id) {
     ...
     */
    public static @Nullable
    SlimefunItem getByItem(@Nullable ItemStack item) {
    ...
    public @Nonnull
    <T> Optional<ItemSetting<T>> getItemSetting(@Nonnull String key, @Nonnull Class<T> c) {
