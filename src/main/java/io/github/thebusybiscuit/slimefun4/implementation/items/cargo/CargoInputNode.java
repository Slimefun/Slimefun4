...
public class CargoInputNode extends AbstractFilterNode {
    ...
    protected void onPlace(BlockPlaceEvent e) {
        ...
        LegacyBlockStorage.addBlockInfo(e.getBlock(), ROUND_ROBIN_MODE, String.valueOf(false));
        LegacyBlockStorage.addBlockInfo(e.getBlock(), SMART_FILL_MODE, String.valueOf(false));
    }
    ...
    protected void updateBlockMenu(BlockMenu menu, Block b) {
        ...
        String roundRobinMode = LegacyBlockStorage.getLocationInfo(b.getLocation(), ROUND_ROBIN_MODE);
        if (!LegacyBlockStorage.hasBlockInfo(b) || roundRobinMode == null || roundRobinMode.equals(String.valueOf(false))) {
            ...
            menu.addMenuClickHandler(24, (p, slot, item, action) -> {
                LegacyBlockStorage.addBlockInfo(b, ROUND_ROBIN_MODE, String.valueOf(true));
            ...
            menu.addMenuClickHandler(24, (p, slot, item, action) -> {
                LegacyBlockStorage.addBlockInfo(b, ROUND_ROBIN_MODE, String.valueOf(false));
                updateBlockMenu(menu, b);
                return false;
            });
        }

        String smartFillNode = LegacyBlockStorage.getLocationInfo(b.getLocation(), SMART_FILL_MODE);
        if (!LegacyBlockStorage.hasBlockInfo(b) || smartFillNode == null || smartFillNode.equals(String.valueOf(false))) {
            ...
            menu.addMenuClickHandler(16, (p, slot, item, action) -> {
                LegacyBlockStorage.addBlockInfo(b, SMART_FILL_MODE, String.valueOf(true));
                updateBlockMenu(menu, b);
                return false;
            });
        } else {
            ...
            menu.addMenuClickHandler(16, (p, slot, item, action) -> {
                LegacyBlockStorage.addBlockInfo(b, SMART_FILL_MODE, String.valueOf(false));
                updateBlockMenu(menu, b);
                return false;
            });
        }
