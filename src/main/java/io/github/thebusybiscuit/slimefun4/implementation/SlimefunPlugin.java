...
import io.github.thebusybiscuit.slimefun4.core.commands.ElevatorCommand;
...
public final class SlimefunPlugin extends JavaPlugin implements SlimefunAddon {
    ...
    private void onPluginStart() {
        ...
        try {
            new ElevatorCommand(this, SlimefunItems.ELEVATOR_PLATE.getItem(ElevatorPlate.class));
        } catch (Exception | LinkageError x) {
            getLogger().log(Level.SEVERE, "Could not initialize /elevator command", x);
        }
