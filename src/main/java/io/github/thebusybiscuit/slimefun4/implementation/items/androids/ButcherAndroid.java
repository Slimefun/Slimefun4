...
public class ButcherAndroid extends ProgrammableAndroid {
    ...
    protected void attack(Block b, BlockFace face, Predicate<LivingEntity> predicate) {
        ...
        for (Entity n : b.getWorld().getNearbyEntities(b.getLocation(), radius, radius, radius, n -> n
            instanceof LivingEntity && !(n instanceof ArmorStand) && !(n instanceof Player) && n.isValid() && predicate.test((LivingEntity) n))) {
