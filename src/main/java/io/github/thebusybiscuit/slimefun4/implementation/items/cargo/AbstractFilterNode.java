...
abstract class AbstractFilterNode extends AbstractCargoNode {
    ...
    protected void onPlace(BlockPlaceEvent e) {
        ...
        LegacyBlockStorage.addBlockInfo(b, FILTER_TYPE, "whitelist");
        LegacyBlockStorage.addBlockInfo(b, FILTER_LORE, String.valueOf(true));
        LegacyBlockStorage.addBlockInfo(b, "filter-durability", String.valueOf(false));
    }
    ...
    protected void updateBlockMenu(BlockMenu menu, Block b) {
        ...
        String filterType = LegacyBlockStorage.getLocationInfo(loc, FILTER_TYPE);

        if (!LegacyBlockStorage.hasBlockInfo(b) || filterType == null || filterType.equals("whitelist")) {
            ...
            menu.addMenuClickHandler(15, (p, slot, item, action) -> {
                LegacyBlockStorage.addBlockInfo(b, FILTER_TYPE, "blacklist");
        ...
        String lore = LegacyBlockStorage.getLocationInfo(b.getLocation(), FILTER_LORE);

        if (!LegacyBlockStorage.hasBlockInfo(b) || lore == null || lore.equals(String.valueOf(true))) {
            ...
            menu.addMenuClickHandler(25, (p, slot, item, action) -> {
                LegacyBlockStorage.addBlockInfo(b, FILTER_LORE, String.valueOf(false));
                updateBlockMenu(menu, b);
                return false;
            });
        } else {
