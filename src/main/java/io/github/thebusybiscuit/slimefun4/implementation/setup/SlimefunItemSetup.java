...
public final class SlimefunItemSetup {
    private static final int ENERGY_RANGE = Slimefun.getCfg().getInt("networks.energy-connector-range");
    private static final int CARGO_RANGE = Slimefun.getCfg().getInt("networks.cargo-connector-range");
    ...
    public static void setup(@Nonnull Slimefun plugin) {
        ...
        new EnergyConnector(itemGroups.electricity, ENERGY_RANGE, SlimefunItems.ENERGY_CONNECTOR, RecipeType.ENHANCED_CRAFTING_TABLE,
        ...
        new CargoConnectorNode(itemGroups.cargo, CARGO_RANGE,SlimefunItems.CARGO_CONNECTOR_NODE, RecipeType.ENHANCED_CRAFTING_TABLE,
