...
public class ElevatorPlate extends SimpleSlimefunItem<BlockUseHandler> {
    ...
    private BlockPlaceHandler onPlace() {
        return new BlockPlaceHandler(false) {
            ...
            public void onPlayerPlace(BlockPlaceEvent e) {
                Block b = e.getBlock();
                BlockStorage.addBlockInfo(b, DATA_KEY, ChatColor.WHITE + "Étage #0");
    ...
    public void openEditor(Player p, Block b) {
        ChestMenu menu = new ChestMenu("Paramètres d'élévateur");

        menu.addItem(4, new CustomItemStack(Material.NAME_TAG, "&7Nom de l'étage &e(Clic pour éditer)", "", ChatColor.WHITE + ChatColors.color(BlockStorage.getLocationInfo(b.getLocation(), DATA_KEY))));
