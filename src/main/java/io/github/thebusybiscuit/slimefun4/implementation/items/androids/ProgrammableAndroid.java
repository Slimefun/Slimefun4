...
public abstract class ProgrammableAndroid extends Android implements InventoryBlock, RecipeDisplayItem {
    ...
    public ProgrammableAndroid(Category category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        ...
        new BlockMenuPreset(getID(), "Programmable Android") {
            ...
            public void newInstance(BlockMenu menu, Block b) {
                menu.replaceExistingItem(15, new CustomItem(SlimefunUtils.getCustomHead("e01c7b5726178974b3b3a01b42a590e54366026fd43808f2a787648843a7f5a"), "&a运行/继续运行"));
                ...
                menu.replaceExistingItem(17, new CustomItem(SlimefunUtils.getCustomHead("16139fd1c5654e56e9e4e2c8be7eb2bd5b499d633616663feee99b74352ad64"), "&4暂停"));
    ...
    private void constructMenu(BlockMenuPreset preset) {
        ...
        if (getTier() == 1) {
            ...
            preset.addItem(34, new CustomItem(generator, "&8\u21E9 &cFuel Input &8\u21E9", "", "&r机器人需要液体燃料", "&r例如岩浆, 原油, 燃油等..."), ChestMenuUtils.getEmptyClickHandler());
        }
        else {
            preset.addItem(34, new CustomItem(generator, "&8\u21E9 &cFuel Input &8\u21E9", "", "&r机器人需要放射性燃料", "&r例如铀, 镎或强化铀"), ChestMenuUtils.getEmptyClickHandler());
        }
    }
