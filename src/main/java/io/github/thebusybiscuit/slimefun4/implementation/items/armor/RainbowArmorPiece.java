...
public class RainbowArmorPiece extends SlimefunArmorPiece {
    ...
    public RainbowArmorPiece(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, DyeColor[] dyeColors) {
        this(itemGroup, item, recipeType.asRecipeCategory(), recipe, dyeColors);
    }
    /**
     ...
     * @param recipeCategory the {@link RecipeCategory} that determines how this {@link RainbowArmorPiece} is crafted
     ...
     */
    @ParametersAreNonnullByDefault
    public RainbowArmorPiece(ItemGroup itemGroup, SlimefunItemStack item, RecipeCategory recipeCategory, ItemStack[] recipe, DyeColor[] dyeColors) {
        super(itemGroup, item, recipeCategory, recipe, new PotionEffect[0]);
