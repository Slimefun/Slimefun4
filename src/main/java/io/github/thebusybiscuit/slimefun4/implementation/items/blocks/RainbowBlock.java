...
public class RainbowBlock extends SimpleSlimefunItem<RainbowTickHandler> {
    ...
    public RainbowBlock(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, ItemStack recipeOutput, RainbowTickHandler ticker) {
        this(itemGroup, item, recipeType.asRecipeCategory(), recipe, recipeOutput, ticker);
    }
    
    @ParametersAreNonnullByDefault
    public RainbowBlock(ItemGroup itemGroup, SlimefunItemStack item, RecipeCategory recipeType, ItemStack[] recipe, ItemStack recipeOutput, RainbowTickHandler ticker) {
