...
public final class ResearchSetup {
    ...
    public static void setupResearches() {
        ...
        register("rainbow_armor", 281, "Wear the Rainbow", 22, SlimefunItems.RAINBOW_HELMET, SlimefunItems.RAINBOW_CHESTPLATE, SlimefunItems.RAINBOW_LEGGINGS, SlimefunItems.RAINBOW_BOOTS);
    }
