...
public class ElectricSmeltery extends AContainer implements NotHopperable {
    ...
    @ParametersAreNonnullByDefault
    public ElectricSmeltery(ItemGroup itemGroup, SlimefunItemStack item, RecipeCategory recipeCategory, ItemStack[] recipe) {
    ...
    public Collection<RecipeCategory> getCraftedCategories() {
        return List.of(RecipeCategory.INGOT_SMELTING);
    }
