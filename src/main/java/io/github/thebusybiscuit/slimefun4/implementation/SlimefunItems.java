...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack GPS_ACTIVATION_DEVICE_GROUP = new SlimefunItemStack("GPS_ACTIVATION_DEVICE_GROUP", Material.STONE_PRESSURE_PLATE, "&fGPS Activation Device &c(Group)", "", "&fPlace this onto a Teleportation Matrix", "&fand step onto this Plate to activate", "&fthe Teleportation Process", "", "&fThis Version allows the user who placed this", "&fDevice to configure a whitelist by right clicking the plate");
