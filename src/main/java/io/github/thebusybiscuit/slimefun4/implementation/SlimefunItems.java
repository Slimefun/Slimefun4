...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack CONTAINMENT_BACKPACK = new SlimefunItemStack("CONTAINMENT_BACKPACK", HeadTexture.CONTAINMENT_BACKPACK, "&2Containment Backpack", "", "&7Size: &e27", BACKPACK_ID, "&7Allows for storing radioactive items", "", LoreBuilder.RIGHT_CLICK_TO_OPEN);
