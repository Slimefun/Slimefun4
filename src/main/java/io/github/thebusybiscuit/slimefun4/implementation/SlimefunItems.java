...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack TALISMAN_HASTIER = new SlimefunItemStack("HASTIER_TALISMAN", Material.EMERALD, "&aTalisman of the Hastier", "&fWhile you have this Talisman", "&fin your inventory it gives", "&fyou a 40% Chance for a decent", "&fHaste buff when you mine a block");
