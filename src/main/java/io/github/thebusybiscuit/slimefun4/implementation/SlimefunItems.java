...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack CRYSTAL_GROWER = new SlimefunItemStack("CRYSTAL_GROWER", Material.FURNACE, "&dCrystal Grower", "", LoreBuilder.machine(MachineTier.BASIC, MachineType.MACHINE), LoreBuilder.speed(1), LoreBuilder.powerPerSecond(20));
