...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack CONTAINMENT_BACKPACK = new SlimefunItemStack("CONTAINMENT_BACKPACK", HeadTexture.CONTAINMENT_BACKPACK, "&2Containment Backpack", "&7Allows you to store radioactive items", "", "&7Size: &e27", BACKPACK_ID, "", LoreBuilder.RIGHT_CLICK_TO_OPEN);
