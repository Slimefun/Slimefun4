...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack FARMER_SHOES = new SlimefunItemStack("FARMER_SHOES", Material.LEATHER_BOOTS, Color.YELLOW, "&eBottes du farmeur", "", "&6&oVous empêche de casser les cultures en sautant");
    public static final SlimefunItemStack INFUSED_MAGNET = new SlimefunItemStack("INFUSED_MAGNET", HeadTexture.MAGNET, "&aAimant", "", "&fCet aimant attire tous", "&fles items autour de vous", "&fdans votre inventaire", "&f(dois être dans l'inventaire pour fonctionner)", "", "&7Tenez la touche &eShift&7 pour récupérer les items autour de vous");
    ...
    public static final SlimefunItemStack BACKPACK_SMALL = new SlimefunItemStack("SMALL_BACKPACK", HeadTexture.BACKPACK, "&eMini sac à dos", "", "&7Taille: &e9", BACKPACK_ID, "", LoreBuilder.RIGHT_CLICK_TO_OPEN);
    ...
    public static final SlimefunItemStack BACKPACK_LARGE = new SlimefunItemStack("LARGE_BACKPACK", HeadTexture.BACKPACK, "&ePetit sac à dos", "", "&7Taille: &e27", BACKPACK_ID, "", LoreBuilder.RIGHT_CLICK_TO_OPEN);
    ...
    public static final SlimefunItemStack RADIANT_BACKPACK = new SlimefunItemStack("RADIANT_BACKPACK", HeadTexture.BACKPACK, "&eGrand sac à dos", "", "&7Taille: &e54 (Double coffre)", BACKPACK_ID, "", LoreBuilder.RIGHT_CLICK_TO_OPEN);
    ...
    public static final SlimefunItemStack EXPLOSIVE_PICKAXE = new SlimefunItemStack("EXPLOSIVE_PICKAXE", Material.DIAMOND_PICKAXE, "&6&lPioche explosive", "", "&fMine un 3x3 autour du", "&fblock que vous minez", "", "&9Fonctionne avec fortune");
    public static final SlimefunItemStack EXPLOSIVE_SHOVEL = new SlimefunItemStack("EXPLOSIVE_SHOVEL", Material.DIAMOND_SHOVEL, "&6&lPelle explosive", "", "&fMine un 3x3 autour du", "&fblock que vous minez");
    ...
    public static final SlimefunItemStack TALISMAN_ANVIL = new SlimefunItemStack("ANVIL_TALISMAN", Material.EMERALD, "&a&lTalisman dernière chance", "", "&fCe talisman empêche un outils de se casser,", "&4ATTENTION&f il sera consommé lorsque", "&fl'item se cassera et réapparaitra dans l'inventaire.", "", "&4&lINFO:", "&4Ce talisman ne fonctionne pas sur", "&4Les outils avec des enchant cheat", "&4a cause de leurs complexité");
    public static final SlimefunItemStack TALISMAN_MINER = new SlimefunItemStack("MINER_TALISMAN", Material.EMERALD, "&a&lTalisman de la fortune", "", "&fQuand vous avez ce talisman", "&fdans votre inventaire, vous avez", "&e20%&f de chance de doubler", "&fLes minerais que vous minez");
    public static final SlimefunItemStack TALISMAN_FARMER = new SlimefunItemStack("FARMER_TALISMAN", Material.EMERALD, "&a&lTalisman du farmeur", "", "&fQuand vous avez ce talisman", "&fdans votre inventaire, vous avez", "&e20%&f de chance de doubler", "&fles recoltes ramassés");
    public static final SlimefunItemStack TALISMAN_HUNTER = new SlimefunItemStack("HUNTER_TALISMAN", Material.EMERALD, "&a&lTalisman du chasseur", "", "&fQuand vous avez ce talisman", "&fdans votre inventaire, vous avez", "&e20%&f de chance de doubler", "&fles drops de monstres que vous tuez");
    ...
    public static final SlimefunItemStack TALISMAN_ANGEL = new SlimefunItemStack("ANGEL_TALISMAN", Material.EMERALD, "&a&lTalisman de l'ange", "", "&fQuand vous avez ce talisman", "&fDans votre inventaire il a", "&e75%&f de chance de vous", "&fempêcher de prendre des dégats de chute");
    ...
    public static final SlimefunItemStack TALISMAN_CAVEMAN = new SlimefunItemStack("CAVEMAN_TALISMAN", Material.EMERALD, "&a&lTalisman du mineur", "", "&fQuand vous avez ce talisman", "&fDans votre inventaire il vous donne", "&e50%&f de chance d'avoir un boost", "&fde vitesse de minage quand vous minez un minerais");
    public static final SlimefunItemStack TALISMAN_WISE = new SlimefunItemStack("WISE_TALISMAN", Material.EMERALD, "&a&lTalisman de la connaissance", "", "&fQuand vous avez ce talisman", "&fDans votre inventaire il vous donne", "&e20%&f de chance de doubler", "&fl'experience que vous reçevez");
    ...
    public static final SlimefunItemStack HOLOGRAM_PROJECTOR = new SlimefunItemStack("HOLOGRAM_PROJECTOR", Material.QUARTZ_SLAB, "&bProjecteur d'hologramme", "", "&fVous permet de créer et éditer un hologramme");
    ...
    public static final SlimefunItemStack ENHANCED_FURNACE_4 = new SlimefunItemStack("ENHANCED_FURNACE_4", Material.FURNACE, "&7Four amélioré", "", "&7Vitesse: &e3x", "&7Efficacité du carburant: &e2x", "&7Multiplicateur: &e1x");
    ...
    public static final SlimefunItemStack ELEVATOR_PLATE = new SlimefunItemStack("ELEVATOR_PLATE", Material.STONE_PRESSURE_PLATE, "&bAscenseur", "", "&fPlacez un ascenseur aux même coordonnées", "&fet a un Y différent pour vous téléporter entre les étages.", "", "&eClique droit sur ce block&7 pour nommer l'étage");
    ...
    // Cargo
    public static final SlimefunItemStack CARGO_MANAGER = new SlimefunItemStack("CARGO_MANAGER", HeadTexture.CARGO_MANAGER, "&6Gestionnaire du système", "", "&fComposant principal d'un systeme de transport d'items");
    public static final SlimefunItemStack CARGO_CONNECTOR_NODE = new SlimefunItemStack("CARGO_NODE", HeadTexture.CARGO_CONNECTOR_NODE, "&7Connecteur de transport", "", "&fComposant pour relier une entrée et une sortie");
    public static final SlimefunItemStack CARGO_INPUT_NODE = new SlimefunItemStack("CARGO_NODE_INPUT", HeadTexture.CARGO_INPUT_NODE, "&7Entrée du système", "", "&fComposant pour faire entrer les items dans le système");
    ...
    public static final SlimefunItemStack CARGO_OUTPUT_NODE_2 = new SlimefunItemStack("CARGO_NODE_OUTPUT_ADVANCED", HeadTexture.CARGO_OUTPUT_NODE, "&6Sortie du système", "", "&fComposant pour faire sortir les items du système");
    ...
    public static final SlimefunItemStack TRASH_CAN = new SlimefunItemStack("TRASH_CAN_BLOCK", HeadTexture.TRASH_CAN, "&3Poubelle automatique", "", "&fDoit être connecté au système de transport");
