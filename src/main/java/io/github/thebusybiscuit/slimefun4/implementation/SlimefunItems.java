...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack EXP_COLLECTOR_2 = new SlimefunItemStack("XP_COLLECTOR_2", HeadTexture.EXP_COLLECTOR, "&aEXP Collector &7(&eII&7)", "", "&fCollects nearby Exp and stores it", "&fRange is a 7x7x7 area", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), LoreBuilder.powerBuffer(2048), LoreBuilder.powerPerSecond(40));
    public static final SlimefunItemStack EXP_COLLECTOR_3 = new SlimefunItemStack("XP_COLLECTOR_3", HeadTexture.EXP_COLLECTOR, "&aEXP Collector &7(&eIII&7)", "", "&fCollects nearby Exp and stores it", "&fRange is a 15x15x15 area", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), LoreBuilder.powerBuffer(4096), LoreBuilder.powerPerSecond(60));
