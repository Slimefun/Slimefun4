...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack HEAD_CRACKER = new SlimefunItemStack("HEAD_CRACKER", Material.IRON_SHOVEL, "&3Head Cracker", "", "&eRight Click&7 to break a head immediately");
