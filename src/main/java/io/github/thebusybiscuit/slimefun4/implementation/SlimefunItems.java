...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack GPS_ACTIVATION_DEVICE_PORTABLE = new SlimefunItemStack("GPS_ACTIVATION_DEVICE_PORTABLE", Material.COMPASS, "&bGPS Portable Teleporter", "", "&fThis device allows you to teleport", "&fto your waypoints from anywhere", "", "&eRight Click&7 to scan");
