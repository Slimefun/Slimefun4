...
abstract public class AItemGenerator extends SlimefunItem implements InventoryBlock, EnergyNetComponent, MachineProcessHolder<CraftingOperation> {
    ...
    protected AItemGenerator(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
    ...
    protected @Nonnull BlockBreakHandler onBlockBreak() {
    ...
    @ParametersAreNonnullByDefault
    protected AItemGenerator(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, ItemStack recipeOutput) {
        this(itemGroup, item, recipeType, recipe);
        this.recipeOutput = recipeOutput;
    }

    @Override
    public @Nonnull MachineProcessor<CraftingOperation> getMachineProcessor() {
        return processor;
    }
     ...
     */
    public final AItemGenerator setCapacity(int capacity) {
     ...
     * @return This method will return the current instance of {@link AContainer}, so that can be chained.
     */
    public final AItemGenerator setProcessingSpeed(int speed) {
     ...
     * @return This method will return the current instance of {@link AContainer}, so that can be chained.
     */
    public final AItemGenerator setEnergyConsumption(int energyConsumption) {
     ...
     */
    public abstract @Nonnull String getMachineIdentifier();
