...
public class VanillaAutoCrafter extends AbstractAutoCrafter {
    ...
    private void offerRecipe(Player p, Block b, List<Recipe> recipes, int index, ChestMenu menu, AsyncRecipeChoiceTask task) {
        ...
        menu.replaceExistingItem(49, CustomItemStack.create(XMaterial.CRAFTING_TABLE.parseMaterial(), ChatColor.GREEN + Slimefun.getLocalization().getMessage(p, "messages.auto-crafting.select")));
