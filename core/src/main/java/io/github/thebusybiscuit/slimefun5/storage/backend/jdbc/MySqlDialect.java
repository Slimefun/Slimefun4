...
public class MySqlDialect implements SqlDialect {
    ...
    private static final String[] PLAYER_DDL = {
        ...
        "CREATE TABLE IF NOT EXISTS player_backpack (uuid VARCHAR(36), backpack_id INT, size INT, contents LONGTEXT, PRIMARY KEY(uuid,backpack_id))",
        "CREATE TABLE IF NOT EXISTS player_waypoint (uuid VARCHAR(36), waypoint_id VARCHAR(255), name VARCHAR(255), world VARCHAR(255), x DOUBLE, y DOUBLE, z DOUBLE, yaw FLOAT, pitch FLOAT, PRIMARY KEY(uuid,waypoint_id))"
    };
