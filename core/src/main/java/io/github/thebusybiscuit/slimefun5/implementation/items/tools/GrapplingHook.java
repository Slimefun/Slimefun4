    ...
    public @Nonnull ItemUseHandler getItemHandler() {
        return e -> {
            ...
            if (!e.getClickedBlock().isPresent() && !Slimefun.getGrapplingHookListener().isGrappling(uuid)) {
                ...
                if (HandCompat.getOffHand(p.getInventory()).getType() == Material.BOW) {
                ...
                if (item.getType() == XMaterial.LEAD.parseMaterial() && isConsumed) {
                ...
                ReflectionCompat.invoke(bat, "setInvulnerable", true);
                bat.setCanPickupItems(false);
                ReflectionCompat.invoke(bat, "setAI", false);
                ReflectionCompat.invoke(bat, "setSilent", true);
                ReflectionCompat.invoke(bat, "setInvisible", true);
