...
public abstract class AbstractRecipe {
    ...
    public static AbstractRecipe of(@Nullable Recipe recipe) {
        if (recipe instanceof ShapedRecipe) {
            ShapedRecipe shapedRecipe = (ShapedRecipe) recipe;            return new VanillaRecipe(shapedRecipe);
        } else if (recipe instanceof ShapelessRecipe) {
            ShapelessRecipe shapelessRecipe = (ShapelessRecipe) recipe;            return new VanillaRecipe(shapelessRecipe);
        } else {
            return null;
        }
    }
