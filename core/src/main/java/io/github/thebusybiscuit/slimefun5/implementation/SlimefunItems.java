...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack SLOT_LOCK = new SlimefunItemStack("SLOT_LOCK", Material.BARRIER, "&cSlot Lock", "", "&7Place this in a multiblock dispenser slot", "&7to lock it (like a vanilla Crafter):", "&7the slot stays empty for the recipe and", "&7hoppers will not fill it.");
