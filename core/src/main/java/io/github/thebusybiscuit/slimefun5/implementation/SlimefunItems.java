...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack SLOT_LOCK = new SlimefunItemStack("SLOT_LOCK", XMaterial.LIGHT_GRAY_STAINED_GLASS_PANE.parseMaterial(), "&7Slot Lock", "", "&7Place this in a multiblock dispenser slot", "&7to lock it (like a vanilla Crafter):", "&7the slot stays empty for the recipe and", "&7hoppers will not fill it.");
