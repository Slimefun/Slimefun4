    ...
    public ItemStack getDrops(@Nonnull Material material, @Nonnull Random random) {
        switch (material.name()) {
            ...
            case "DEEPSLATE_LAPIS_ORE":
                return new ItemStack(Material.valueOf("LAPIS_LAZULI"), 4 + random.nextInt(4));
            case "COPPER_ORE":
            case "DEEPSLATE_COPPER_ORE":
                return new ItemStack(Material.valueOf("RAW_COPPER"));
            case "IRON_ORE":
            case "DEEPSLATE_IRON_ORE":
                return new ItemStack(Material.valueOf("RAW_IRON"));
            case "GOLD_ORE":
            case "DEEPSLATE_GOLD_ORE":
                return new ItemStack(Material.valueOf("RAW_GOLD"));
            default:
