...
* If a parameter is annotated with `@Nonnull`, you should enforce this behaviour by doing `Preconditions.checkArgument(variable != null, "...");` and give a meaningful message about what went wrong
